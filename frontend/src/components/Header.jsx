...
const Header = () => {
  ...
  const menuItems = [
    ...
    { label: "Newsletter", path: "https://liberdademedica.substack.com/", external: true },
    { label: "Instagram", path: "https://www.instagram.com/liberdademedicaedu", external: true },
    { label: "Youtube", path: "https://www.youtube.com/@liberdademedicatv", external: true },
